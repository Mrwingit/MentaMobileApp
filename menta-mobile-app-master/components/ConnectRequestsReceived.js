...
const ConnectRequestsSent = props => {
  ...
  const handleGetRequests = async () => {
    ...
    const result = props.navigation.state.params.requestsRecieved
    setRequests(result);
  }
  ...
  return requests && (
    ...
    requests.map((item, num) => (
      ...
      bottomDivider
      onPress={() =>  props.navigation.navigate('ProfileView', {userViewing: item, pageRenderedFrom: 'ConnectRequestsRecieved', userType: item.userTypeToCurrent })}
      // rightIcon={
      // <>
