...
import { Text, View, StyleSheet, Group, FlatList, ScrollView} from 'react-native'
...
<ScrollView>
    ...
    matches.map((item, num) => (
      ...
      bottomDivider
      // onPress={() => props.setSelectedUser(item)}
      onPress={() =>  props.navigation.navigate('ProfileView', {userViewing: item, pageRenderedFrom: 'ConnectMatches', userType: props.navigation.state.params.userType })}
      chevron
    />
    ))
  }
